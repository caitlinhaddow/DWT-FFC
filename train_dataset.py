## CH Dissertation: new file added as was missing from github. Adapted code from ITB-Dehaze (same authors) following parameters in paper
...
## CH Dissertation: data augmentation as described in paper
...
class dehaze_train_dataset(Dataset):
    ...
    def __getitem__(self, index, is_train = True):
        if is_train:
            ...
            #crop a patch
            i,j,h,w = transforms.RandomCrop.get_params(hazy, output_size = (384,384)) ## CH Dissertation: random cropping matching paper
        ...
        # return hazy,clean
        ## CH Dissertation: fixed mistakes in parameter code
